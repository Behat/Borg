Feature: Manager can generate documentation
  ...
  Scenario: Generating behat 3.0 documentation
    ...
    Then the documentation for "behat/docs" version v3.0 should have been built
  ...
  Scenario: Generating both behat 2.5 and 3.0 documentation
    ...
    When I build the documentation
    Then the documentation for "behat/docs" version v2.5 should have been built
    And the documentation for "behat/docs" version v3.0 should have been built
  ...
  Scenario: Regenerating updated documentation
    ...
    Then the documentation for "behat/docs" version v2.5 should have been rebuilt
    But the documentation for "behat/docs" version v3.0 should not have been rebuilt
