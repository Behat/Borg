Feature: Documentation meta is generated after publishing
  ...
  Scenario: Getting documentation package name and update time
    Given "Behat/Symfony2Extension" version "v2.0.0" was documented on "04.09.2014"
    ...
    And documentation time of "index.html" page for "Behat/Symfony2Extension" version "v2.0" should be "04.09.2014"
